...
static inline ImVec2 ImRound( ImVec2 v )
{
...
namespace ImGui
{
	...
	inline IMGUI_API ImU32 GetColorU32( ImGuiCol idx, float alpha_mul )
	{
	...
	inline IMGUI_API ImU32 GetColorU32( const ImVec4& col )
	{
		ImVec4 c = col;
